...
//      dump('aa');die;
    ...
    // 邮箱注册
      ...
      $m3_email->to = $email;
      $m3_email->cc = '1260185038@qq.com';
      $m3_email->subject = '凯恩书店验证';
      $m3_email->content = '请于24小时点击该链接完成验证. http://localhost/service/validate_email'
                        . '?member_id=' . $member->id
                        . '&code=' . $uuid;
  ...
  public function login(Request $request){
      ...
      if($member == null){
          $m3_result->status = 2;
          $m3_result->result = '该用户不存在';
          return $m3_result->toJson();
      }else{
          if(md5('bk'+$password) != $member->password){
              $m3_result->status = 3;
              $m3_result->result = '密码不正确';
              return $m3_result->toJson();
